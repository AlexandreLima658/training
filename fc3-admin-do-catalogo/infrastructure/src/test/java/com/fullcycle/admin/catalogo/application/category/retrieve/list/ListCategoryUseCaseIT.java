...
public class ListCategoryUseCaseIT {
    ...
    void mockUp(){
        final var categories = Stream.of(
                ...
                Category.newCategory("Documentários", "", true),
    ...
    public void givenAValidTerm_whenTermDoesntMatchsPrePersisted_shouldReturnEmptyPage(){
        ...
        final var expectedTerms = "asdfg asdasdad";
        ...
        final var actionResult = useCase.execute(aQuery);

        Assertions.assertEquals(expectedItemsCount, actionResult.items().size());
        Assertions.assertEquals(expectedPage, actionResult.currentPage());
        Assertions.assertEquals(expectedPerPage, actionResult.perPage());
        Assertions.assertEquals(expectedTotal, actionResult.total());
    ...
    public void givenAValidTerm_whenCallsListCategories_shouldReturnCategoriesFilteres(
        ...
        Assertions.assertEquals(expectedPerPage, actionResult.perPage());
        Assertions.assertEquals(expectedTotal, actionResult.total());
        Assertions.assertEquals(expectedCategoryName, actionResult.items().get(0).name());
    }
