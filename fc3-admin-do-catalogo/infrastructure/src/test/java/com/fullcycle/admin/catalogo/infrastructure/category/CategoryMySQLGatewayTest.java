...
public class CategoryMySQLGatewayTest {
    ...
    @Test
    public void givenPrePersistedCategoriesAndDocAsTerm_whenCallsFindAllAndTermsMatchsCategoryName_shouldReturnPaginated(){
        final var expectedPage = 0;
        final var expectedPerPage = 1;
    ...
    @Test
    public void givenPrePersistedCategoriesAndMaisAssitidaAsTerm_whenCallsFindAllAndTermsMatchsCategoryDescription_shouldReturnPaginated(){
        final var expectedPage = 0;
        final var expectedPerPage = 1;
        final var expectedTotal = 1;
