...
public class CategoryTest {
    ...
    public void givenAInvalidNameLengthMoreThan255_whenCallNewCategoryAndValidate_thenShouldReceiveError() {
        final String expectedName =
                """
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed nec sodales tortor. Suspendisse non feugiat ex.
                            Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vivamus dui ante,
                            ultricies id placerat in porttitor.
                        """;
        final var expectedErrorCount = 1;
        final var expectedErrorMessage = "'name' should not be between 3 and 255 characters";
        final var expectedDescription = "A categoria mais assistida";
